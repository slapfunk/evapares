...
$string['create_groups'] = 'Create Groups';
...
$string['DeliverableDate'] = 'Due Date' ;
...
$string['finalEval'] = 'Final Evaluation' ;
$string['initialEval'] = 'Initial evaluation';
$string['keeps'] = 'it keeps';
...
$string['no_groups'] = 'You must create groups to continue the activity';
$string['nogroup'] = 'You do not belong to any group , so you can not make evaluations';
...
$string['permission'] = 'You do not have permission to access this page .';
...
$string['ssc'] = 'The Stop, Start, Continue (SSC) methodogy consists of three text boxes. Inside the "Stop" box the student writes what he thinks his groupmate should stop doing. In the "Start" box the student writes what his groupmate should start doing. Finally, in the "Continue", the student has the option to write what he sees as his groupmates best traits and what he should continue doing. This methodology is used for diverse motives, spanning communication, personal development, teamwork, problem solving, among others. ' ;
$string['ssc_help'] = 'Add SSC';
