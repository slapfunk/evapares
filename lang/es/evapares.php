...
$string['create_groups'] = 'Crear Grupos';
$string['datestart'] = 'Fecha Inicio';
$string['dateend'] = 'Fecha Termino';
...
$string['group'] = "Grupo" ;
$string['improved']= 'Mejorá';
$string['finalEval'] = 'Evaluación Final' ; 
$string['initialEval'] = 'Evaluación Inicial';
$string['keeps'] = 'Se mantiene';
...
$string['no_groups'] = 'Debe crear grupos para continuar con la actividad';
$string['nogroup'] = 'No perteneces a ningun grupo, por lo cual no puedes realizar las evaluaciones.';
...
$string['permission'] = 'No tiene los permisos para ingresar a esta página.';
...
$string['undelivered'] = 'No Entregado';
